...
ClientNumber=${Number}
docker run  -i -t -P  --net=host --privileged=true   --name=$masterhost  $buildimg  M D
...
do
docker run  -i -t -P  --net=host --privileged=true   --name="$comhost$ii"  $buildimg C D $masterhost
done
docker ps
